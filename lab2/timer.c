...
u32_t globalCounter = 0; //counter used in the cycle of timer_test_int (lab2.c)
...
void (timer_int_handler)() //increments the globalCounter
{
  globalCounter++;
}
